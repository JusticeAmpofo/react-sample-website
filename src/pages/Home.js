    ...
    const tabs = [
        {
            id: 1,
            label: 'Tab 1',
            content: <p className="mb5">Content for Tab 1</p>,
        },
        {
            id: 2,
            label: 'Tab 2',
            content: <p className="mb5">Content for Tab 2</p>,
        },
        {
            id: 3,
            label: 'Tab 3',
            content: <p className="mb5">Content for Tab 3</p>,
        },
    ];
    ...
    return (
        <>
            <div className="container home">
                ...
                <button onClick={() => {setModalAOpen(true)}} className="btn mb5">Open Modal</button>
                ...
                <p className="mb5">Quisque vitae augue id risus pulvinar tincidunt a eu turpis. Maecenas nec dolor in lorem molestie tincidunt eget et ipsum. Mauris et mi nec orci posuere pulvinar quis a purus. Phasellus et rhoncus massa. Curabitur id auctor ligula. Cras ornare arcu sit amet porta sollicitudin. Aliquam a eros finibus, elementum sem vitae, posuere nisi. Duis dignissim vitae elit at accumsan. Cras ut dolor vitae felis euismod sagittis sit amet ut eros. Sed ut ante nec lacus euismod volutpat vel laoreet massa. Nam malesuada vulputate sem, ut commodo enim elementum quis. Morbi mollis dolor eu dolor auctor, eu tempus risus laoreet.</p>
                <p className="mb5">Sed in cursus ipsum. Vivamus lacus turpis, lobortis aliquet posuere non, fermentum in enim. Pellentesque et ligula tincidunt, faucibus dolor id, molestie turpis. Praesent dolor dolor, aliquet vel sodales eget, mollis et lacus. Suspendisse non urna nibh. Nullam et eleifend est, ac faucibus nisl. Nullam at elit vel magna consequat sagittis. Sed ultricies suscipit luctus. In porttitor viverra elementum. Ut varius arcu in dui interdum dignissim. Suspendisse nec dictum urna. Fusce a lorem at nunc dictum efficitur ut quis enim. Integer vel nisl a dolor consectetur faucibus. In porta lorem sit amet eros hendrerit rutrum.</p>
